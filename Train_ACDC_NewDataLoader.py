"""
ACDC数据集的训练函数 使用了新的DataLoader
新的DataLoader就是增加了一定的图像增强
"""
...
# 新的ACDC的Dataloader
from DataLoader_ACDC_V2 import ACDCdataset as ACDC_dataset
from DataLoader_ACDC_V2 import RandomGenerator as ACDC_RandomGenerator
