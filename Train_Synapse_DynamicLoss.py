...
from network.DDL_Source_128channel import UNet # 导入129层的网络进行尝试
...
class CeDiceLoss_functionnal(nn.Module):
    ...
    def _adjust_loss_weights_3(self, epoch, k=0.1, x0=120):
...
if __name__ == "__main__":
    ...
    # 模型实例化
    model = UNet(n_channels=1,n_classes=9).to(device=device)
